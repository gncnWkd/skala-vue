...
const { favoriteWeatherData, favoriteCityIds, isLoading, error, weatherData } =
  storeToRefs(weatherStore)
const favoriteCities = computed(() =>
  favoriteWeatherData.value.map((city) => ({
    ...city,
...
<template>
  <section class="favorite-page">
    <header class="page-hero">
      ...
      <el-button v-if="favoriteCityIds.length" plain type="danger" @click="removeAllFavorites"
        >모두 해제</el-button
      >
    </header>
    ...
    <section class="dashboard-section">
      <div class="section-heading">
        <div>
          <p class="section-kicker">FAVORITE WEATHER</p>
          <h2>내 즐겨찾기</h2>
        </div>
      ...
      <BaseDashboardCard>
        ...
        />
        <el-empty
          v-else-if="!favoriteCityIds.length"
          :image-size="86"
          description="아직 즐겨찾는 지역이 없습니다."
        >
